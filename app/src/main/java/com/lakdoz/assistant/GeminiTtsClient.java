...
public class GeminiTtsClient {
    ...
    private AudioData synthesize(String key, String model, String voice, String style, String text) throws Exception {
        ...
        String prompt = (style == null || style.trim().isEmpty() ? "Doğal, sıcak ve akıcı bir Türkçe ile konuş." : style.trim()) + " Konuşma temposu doğal ama normalden yaklaşık yüzde 15 daha hızlı olsun; kelimeleri yutma." + "\nMetni aynen ve doğal Türkçe ile seslendir:\n" + text;
